<template>
  <div class="overflow-x-auto lg:overflow-x-hidden tablecont">
    <h1 class="text-xl" style="padding: 8px">Recent Bookings</h1>
    <table class="w-full mt-8">
        ...
        <tr v-for="booking in bookings" :key="booking.id" class="">
            ...
            <td>
            <button style="min-width: 100px" class="text-sm text-green-500 rounded-3xl px-2 py-2 border border-solid border-green-500 bg-white">View</button>
            </td>
        </tr>
        </tbody>
        <tbody v-else>
        <div class="text-center py-4">
            ...
            <p class="mt-4">No recent Bookings (#0)</p>
        </div>
        </tbody>
    </table>
</div>
