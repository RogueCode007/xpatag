   ...
   <div class="l-modal">
      <div class="loading-modal w-full">
          <div class="loader bg-white mx-auto pb-8">
            ...
            <p class="text-xl text-black font-bold text-center pt-6 pb-3">New Service created</p>
            <p class="mt-4 p-2 w-3/4 mx-auto border text-center border-solid text-xs" style="border-radius: 22px; color: #52B95E; border-color: #52B95E">https://xpatag.com/horpey/service1</p>
            <a href="#" class="text-center block w-3/4 mx-auto mt-10 p-2 text-white text-sm" style="background: #52B95E;border-radius: 22px;">Share Service</a>
          </div>
      </div>
    </div>
</template>
