<template>
   <div class="l-modal">
      <div class="loading-modal w-full">
          <div class="loader bg-white mx-auto py-10">
            <svg class="block w-full" width="98" height="98" viewBox="0 0 98 98" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p class="text-xl text-black font-bold text-center pt-6 pb-3">Profile Completed</p>
            <p class="mt-4 p-2 w-3/4 mx-auto text-center text-sm" style="border-radius: 22px; color: #454545;">Congratulations on your account set up, you will receive a notification within 24 hours after our expert team has reviewed. 
Now you can move to the fun part; creating your first service. </p>
            <button @click="close" class="text-center block w-3/4 mx-auto mt-10 p-2 text-white text-sm" style="background: #52B95E;border-radius: 22px;">Contnue</button>
          </div>
      </div>
    </div>
</template>
...
export default {
    methods:{
        close(){
            this.$emit('close')
            this.$router.push('/app/dashboard/profile')
        }
    }
}
</script>
