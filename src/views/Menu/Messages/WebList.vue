<template>
  <div class="border rounded pt-4 list">
      <div class="px-2 mb-6">
            <h1 class="font-bold text-xl">All messages</h1>
            <div class="mt-4 py-3 flex items-center gap-2 border rounded px-2">
      ...
      <div class="listbox">
            <div v-for="(person, index) in list" :key="index" class="flex items-start mb-4 cursor-pointer py-4 px-2" :class="[person.name == selected.name ? 'active': '']"  @click="handleClick(person)">
